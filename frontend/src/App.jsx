...
import StocksPage from "./pages/StocksPage"; // Import the new StocksPage
import "./styles.css";

function App() {
  const [activePage, setActivePage] = useState("sales"); // 'sales', 'products', 'stocks', or 'sales-report'
